...
-(void)timelabel{
    ...
    NSLayoutConstraint *rightToolConstraint = [NSLayoutConstraint constraintWithItem:self.time attribute:NSLayoutAttributeTrailing relatedBy:NSLayoutRelationEqual toItem:controllView attribute:NSLayoutAttributeTrailing multiplier:1 constant:-15];
...
-(void)playbtn{
    ...
    NSLayoutConstraint *leftToolConstraint = [NSLayoutConstraint constraintWithItem:self.playBtn attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:controllView attribute:NSLayoutAttributeLeading multiplier:1.0f constant:15];
